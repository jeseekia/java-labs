...
//Handle errors for inputting an unexpected type of input
			try {
//Scan for user input
...
//If the user does not enter the expected type of input, the program will exit				
				System.out.println("It looks like you didn't enter a valid response.");
			}
